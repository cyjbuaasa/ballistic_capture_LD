function mycall_map0709(hObject,~,hAx,t0,t_end,alp_mesh,Psi_mesh,orbDEX,r2,theta,v_vert,J0,nonlinear_id,m_STT,...
    dyn_str,eps,alp,keta,dx_eps,LD_str)
    ...
    if v < 3
        ...
        [orb_dynam_index,Np_prl,eve_struct,t,X,tend,xend,eve] = get_Dyindex(t0,t_end*2.0,y0,nonlinear_id,m_STT,...
