function [LD_FTLE_i,LD_a2_i,Np_prl_i,KEarth_i,KMoon_i,KEscape_i,tend,xend,eve] = get_Dy_LD_cons_tend(t0,t_end,num_tend,y0,...
...
for kt = 1:num_tend
    id_t = find(abs(t-(t0+t_end(kt))) < 1e-8,1,'last');
    if ~isempty(id_t)
